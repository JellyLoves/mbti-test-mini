 ...
 */
export default function getBastQuestionResult(answerList, questions, question_results) {
...
console.log(getBastQuestionResult(answerList, questions, question_results));
